...
public class OBD_tworzenie_db {
	public static void tworzenie() {
		...
		try {
			...
			String sqlCreatePrzedmiot = "CREATE TABLE przedmiot (idp integer not null, nazwa_przedmiotu char(20))";
			String sqlCreateNauczyciel = "CREATE TABLE nauczyciel (idn integer not null, nazwisko_nauczyciela char(30), imie_nauczyciela char(20))";
			String sqlCreateOcena = "CREATE TABLE ocena (ido integer not null, wartosc_opisowa char(20), wartosc_numeryczna float)";
			String sqlCreateUczen = "CREATE TABLE uczen (idu integer not null, nazwisko_ucznia char(30), imie_ucznia char(20))";
			String sqlCreateOcenianie = "CREATE TABLE ocenianie (idn integer not null, idu integer not null, idp integer not null, ido integer not null, rodzaj_oceny char(1))";
			...
			System.out.println("Nieudane połączenie z bazą danych/baza danych juz istnieje");
